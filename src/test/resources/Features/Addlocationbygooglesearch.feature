Feature: Addlocation by Google search 

  Scenario: Check if adding a location is successful with valid data by Google search
    ...
    Then Click on the Search bar and enter the location "simla"
